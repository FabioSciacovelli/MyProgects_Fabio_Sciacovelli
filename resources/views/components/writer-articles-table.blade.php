          ...
          <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <td>
                            <a href="{{route('article.show', compact('article'))}}" class="btn back rounded-0 text-white">Leggi l'articolo</a>
                            <a href="{{route('article.edit', compact('article'))}}" class="btn back rounded-0 text-white">Modifica l'articolo</a>
                            <form action="{{route('article.destroy', compact('article'))}}" method="POST" class="d-inline">
                                @csrf
                                @method('delete')
                                <button type="submit" class="btn btn-danger rounded-0">Elimina articolo</button>
                            </form>
                        </td>
                </tr>
                @endforeach
